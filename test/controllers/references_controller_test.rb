...
class ReferencesControllerTest < ActionController::TestCase
  ...
  test "should create reference" do
    assert_difference('Reference.count') do
      post :create, reference: { company_address: @reference.company_address, email: @reference.email, first_name: @reference.first_name, last_name: @reference.last_name, sex: @reference.sex, tel: @reference.tel }
    end
  ...
  test "should update reference" do
    patch :update, id: @reference, reference: { company_address: @reference.company_address, email: @reference.email, first_name: @reference.first_name, last_name: @reference.last_name, sex: @reference.sex, tel: @reference.tel }
    assert_redirected_to reference_path(assigns(:reference))
  end
